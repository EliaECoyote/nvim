...
function M.setup_theme(colors, status_colors)
  ...
  local hi_config = {
    ...
    OrgTSHeadlineLevel4           = { fg = colors.base0A, bold = true },
    OrgTSHeadlineLevel5           = { fg = colors.base0B, bold = true },
    OrgTSHeadlineLevel6           = { fg = colors.base0C, bold = true },
    OrgTSHeadlineLevel7           = { fg = colors.base0E, bold = true },
    OrgTSHeadlineLevel8           = { fg = colors.base0F, bold = true },
    -- Git highlights
